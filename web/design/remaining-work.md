...
| 2 | **Cost as a weight.** A Price chip in the blend row, mapped onto the score's own scale on a log curve, weighing only models the source measured. All four design questions answered in the spec. | **BUILT 2026-09-03** | `web/design/score-surface.md`, "Price as a weight" |
